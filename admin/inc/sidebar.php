            ...
            <ul class="section menu">
                ...
                <li><a class="menuitem">Danh mục</a>
                    <ul class="submenu">
                        ...
                        <li><a href="catlist.php">Danh sách các danh mục</a> </li>
                    </ul>
                </li>
                ...
                <li><a class="menuitem">Thương hiệu</a>
                    <ul class="submenu">
                        ...
                        <li><a href="brandlist.php">Danh sách các thương hiệu</a> </li>
                    </ul>
                </li>
                <li><a class="menuitem">Sản phẩm</a>
                    <ul class="submenu">
                        <li><a href="productadd.php">Thêm sản phẩm</a> </li>
                        <li><a href="productlist.php">Danh sách các sản phẩm</a> </li>
                    </ul>
                </li>
            </ul>
        </div>
