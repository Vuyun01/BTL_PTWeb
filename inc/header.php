...
<?php
	...
	include_once 'classes/inbox.php';
...
<!DOCTYPE HTML>
<head>
<title>Trang bán hàng công nghệ</title>
						...
						<a href="#" title="View my shopping cart" rel="nofollow">
								...
								<span class="no_product">
  									<?php
										...
										if($check_cart){
											$show_quantity = Session::get("quantity_prod");
											echo $show_quantity.' '.'sp';
										} else{
											echo "Trống";
										}
									?>
...
<div class="menu">
	<ul id="dc_mega-menu-orange" class="dc_mm-orange">
	  ...
	  <?php
	  	...
	  	$check_order = $cart->check_order($cus_id);
		if(isset($check_order)){
			echo '<li><a href="orderdetails.php">Hóa đơn</a> </li>';
		}
	  ?>
