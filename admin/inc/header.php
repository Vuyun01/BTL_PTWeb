    ...
    <div class="container_12">
        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <li class="ic-form-style"><a href="manageusers.php"><span>Quản trị người dùng</span></a></li>
				<li class="ic-form-style"><a href="changepassword.php"><span>Đổi mật khẩu</span></a></li>
				<li class="ic-grid-tables"><a href="inbox.php"><span>Hòm thư</span></a></li>
				<li class="ic-grid-tables"><a href="orderManage.php"><span>Quản lý đơn hàng</span></a></li>
